...
- input3: here you must list all the effects you want to play (from the [ParticlesAddon](/docs/configuring-dimensions/addons/premium-addons/particles-addon.md)) and the delay for every effect.
