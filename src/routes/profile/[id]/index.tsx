            ...
            <div class="animate-in fade-in space-y-6 rounded-2xl border border-gray-900 bg-gray-900/30 p-6 duration-200">
              <div>
                ...
                <p class="mt-1 text-[10px] text-gray-500">
                  Configure the particle effects and cosmetics displayed when
                  you interact with portals in-game.
                </p>
              </div>
                  ...
                  <Form action={updateCosmetics} class="max-w-md space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {availableCosmetics
                          .filter((c: any) =>
                            JSON.parse(c.used).includes('use')
                          )
                          .map((c: any, idx: number) => (
                            <option key={idx} value={c.name}>
                              {c.name}
                    ...
                    <div>
                      ...
                      >
                        ...
                        {availableCosmetics
                          .filter((c: any) =>
                            JSON.parse(c.used).includes('tick')
                          )
                          .map((c: any, idx: number) => (
                            <option key={idx} value={c.name}>
                              {c.name}
